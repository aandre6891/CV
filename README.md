...
I worked on the company's websites for a few years (all built with Wordpress) and also managed a small team of front and back-end developers. During that experience I realized my interest in coding, but never had time and chance to change my path. In my spare time I always made some projects on my own, like blogs, websites for me and for friends (always using Wordpress), like my latest project Yivro.com.
